...
subplot(3,1,1); plot(Hp_values, fcl_jet, 'r');xlabel('Hp (ft)');ylabel('fcl jet (kg/min))');
title('climb fuel flow jet');
subplot(3,1,2); plot(Hp_values, fcl_turbo, 'r'); xlabel('Hp (ft)'); ylabel('fcl turbo (kg/min)');
title('climb fuel flow turboprop');
subplot(3,1,3); plot(Hp_values, fcl_piston, 'r'); xlabel('Hp (ft)'); ylabel('fcl piston (kg/min)');
title('climb fuel flow piston');

figure;

subplot(3,1,1); plot(Hp_values, fdes_jet, 'r');xlabel('Hp (ft)');ylabel('fdes jet (kg/min)');
title('descent fuel flow jet');
subplot(3,1,2); plot(Hp_values, fdes_turbo, 'r'); xlabel('Hp (ft)'); ylabel('fdes turbo (kg/min)');
title('descent fuel flow turboprop');
subplot(3,1,3); plot(Hp_values, fdes_piston, 'r'); xlabel('Hp (ft)'); ylabel('fdes piston (kg/min)');
title('descent fuel flow piston');


figure;

subplot(3,1,1); plot(Hp_values, fcr_jet, 'r');xlabel('Hp (ft)');ylabel('fcr jet (kg/min)');
title('cruise fuel flow jet');
subplot(3,1,2); plot(Hp_values, fcr_turbo, 'r'); xlabel('Hp (ft)'); ylabel('fcr turbo (kg/min)');
title('cruise fuel flow turboprop');
subplot(3,1,3); plot(Hp_values, fcr_piston, 'r'); xlabel('Hp (ft)'); ylabel('fcr piston (kg/min)');
